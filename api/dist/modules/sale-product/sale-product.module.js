...
const sale_product_controller_1 = require("./sale-product.controller");
...
exports.SaleProductModule = SaleProductModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [sale_product_service_1.SaleProductService],
        exports: [sale_product_service_1.SaleProductService],
        imports: [subscribe_module_1.SubscribeModule],
    })
], SaleProductModule);
//# sourceMappingURL=sale-product.module.js.map